...
@section('content')
    ...
    <div class="container">
        <div class="box-title-panel">
            <!-- title -->
            <h1>
                Про сервіс працевлаштування в Європі - work.es.ua.com
            </h1>
            ...
            <div class="block-page">
                ...
                <p>
                    ...
                    Мета проекту work.es.ua.com – максимально допомогти кожному Українцю, який потребує отримання роботи. Сервіс включає 45 країн Європи.
                    На ньому кожен офіційний роботодавець може розмістити свої вакансії, зняти навантаження своєї держави соціальних виплат,
                ...
                <div class="box-above-photo">
                    <div class="above-text">
                        <p>
                            ...
                            увесь свій час приділяю цьому проекту. Є ідея, ціль, рух. Залишилася справа за малим, мені потрібна допомога:
                        </p>
                        <ol>
                        ...
                        <p>
                            Готовий розглядати пропозиції та проводити доопрацювання сервісу для окремо взятої країни та її стандартів.
                        </p>
                    </div>
                </div>
