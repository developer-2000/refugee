        ...
        <div class="box-page">
            <div class="box-title-panel">
                ...
                <div class="block-page">
                    ...
                    <p>
                        Настало время перемен. И по закону природы – там где убывает, обязательно найдется то что
                        восполняет.
                        Первое с чем я столкнулся после отъезда родных в Европу, это выбор принимающей страны, в которой
                        могут они остановится.
                        Меня интересовало жилье, питание, минимальная финансовая помощь и конечно трудоустройство. С
                        последним оказалось сложней всего.
                        Это и стало моментом истины, днем начало моего стартапа, этого сайта на котором вы находитесь.
                        Цель проекта - максимально помочь каждому Украинцу, нуждающемуся в получении
                        работы. Сервис включает в себя 45 стран Европы.
                        На нем каждый официальный работодатель, может разместить свои вакансии, снять нагрузку своего
                        государства социальных выплат,
                    ...
                    <div class="box-above-photo">
                        <div class="above-text">
                            <p>
                                ...
                                <a href="{{ route('show-charity') }}">необходима ваша потдержка</a>:
                            </p>
                            <ol>
