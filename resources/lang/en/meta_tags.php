...
return [
    ...
    "index_page" => [
        "title" => 'Work in Europe. Current vacancies from the employer and resumes of employees. ',
        "description" => ' free service for finding and providing jobs in Europe. Lots of vacancies and resumes, event notifications, mailing.',
    ...
    "vacancies_city" => [
        ...
        "open_graph" => 'Good salary. Legal employment.',
    ],
    "show_vacancy" => [
        "title" => ':user_name (Job: ":title", :salary€) ',
    ...
    "all_resumes" => [
        "title" => 'Current resumes of candidates. Search for employees in Europe. ',
    ...
    "show_resume" => [
        "title" => ':user_name (Resume ":title" in :address) ',
        "description" => 'Resume, employee, candidate ":title" is looking a job. ',
    ...
    "show_company" => [
        "title" => 'The company ":company" employer in Europe ',
