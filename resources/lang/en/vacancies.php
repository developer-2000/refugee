...
return [
    ...
    'helps_track_have_quick'=>'Helps you track and have quick access to the information you need.',
    'remove'=>'Remove',
    'reset_all'=>'reset all',
    'location'=>'Location',
    ...
    'do_not_show2'=>"This section stores resumes that you have hidden on the resume search page by clicking on the «Do not show» button with an icon like",
     ...
     'these_resumes_will_not_show'=>"These resumes will not show up on the search page and serve as something you don't want to deal with in the future.",
    ...
    'helps_you_track'=>"Helps you track and have full access to your resumes.",
