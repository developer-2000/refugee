...
return [
    ...
    "welcome" => "Добро пожаловать в Work-Europe-Ukraine.",
    ...
    "to_work_effectively" => "2) Для эффективной работы приведите в порядок свои личные данные: ",
    "employer_and_employee" => "Работодателю и Сотруднику - ",
    "personal_information" => "Личная информация",
    "for_the_employer" => "Для Работодателя - ",
    "my_company_information" => "Информация моей компании",
    "start_creating_offers" => "3) Приступайте к созданию своих предложений:",
