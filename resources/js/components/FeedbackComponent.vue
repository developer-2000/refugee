<template>
    <div class="container feedback">
        ...
        <div class="block-body">
            <p>
                Заполните форму ниже, и представитель сервиса свяжется с вами в ближайшее время.
            </p>
            ...
            <div class="box-inputs">
                ...
                <div class="form-group">
                    ...
                    <div class="invalid-feedback" v-if="!$v.email.required">
                        Пожалуйста введите свой контактный Email
                    </div>
        ...
        <div class="box-alert-exit">
            <div class="alert-exit">
                ...
                <br> Ваше сообщение успешно отправлено. <br> Отслеживайте указанную почту для дальнейшей переписки. <br> Спасибо за контакт с нами.
            </div>
