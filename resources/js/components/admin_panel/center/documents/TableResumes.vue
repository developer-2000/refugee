<template>
    <div id="table_page">
                        ...
                        <div class="card">
                            ...
                            <div class="row card-body">
                                ...
                                <table id="main-table" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <tr v-for="(resume, key) in resumes" :key="key">
                                            <td colspan="8">
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <table class="table-document" :id="`table-document_${key}`" :data-index="key">
                                                            <tr class="row">
                                                                ...
                                                                <!-- перепроверка -->
                                                                <td class="col-sm-1">
                                                                    <svg v-if="checkBlocked(resume)" class="small-dot active" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path d="M320 256c0 88.37-71.63 160-160 160S0 344.37 0 256 71.63 96 160 96s160 71.6 160 160z"/></svg>
                                                                ...
                                                                <td class="col-sm-1">
                                                                    <svg :class="`small-dot ${statusView(resume.job_posting)}`" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path d="M320 256c0 88.37-71.63 160-160 160S0 344.37 0 256 71.63 96 160 96s160 71.6 160 160z"/></svg>
                                                                </td>
                                                                <!-- допуск к показам -->
                                                                <td class="col-sm-1">
                                                                    <svg :class="`small-dot ${accessView(resume.published)}`" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path d="M320 256c0 88.37-71.63 160-160 160S0 344.37 0 256 71.63 96 160 96s160 71.6 160 160z"/></svg>
                                                                </td>
                                                                <!-- проверен админом -->
                                                                <td class="col-sm-1">
                                                                    <svg :class="`small-dot ${accessView(resume.check_admin)}`" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path d="M320 256c0 88.37-71.63 160-160 160S0 344.37 0 256 71.63 96 160 96s160 71.6 160 160z"/></svg>
                                                                </td>
                                                                <!-- создан -->
                                                                <td class="col-sm-1">
                                                                    {{getDateString(resume.created_at)}}
                                                                </td>
                                                                <!-- button menu -->
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="box-element-vacancy">
                                                                    ...
                                                                    <div :class="`value-element value-element_${key}`">
                                                                        ...
                                                                        <span v-if="resume.salary.comment !== null" class=" important">
                                                                ...
                                                                <div class="box-element-vacancy">
                                                                    ...
                                                                    <div :class="`value-element value-element_${key}`"
                                                                         v-html="viewCategories(resume.categories)"
                                                                    >
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="box-element-vacancy">
                                                                    ...
                                                                    <div :class="`value-element value-element_${key} important`">
                                                                        {{getDateString(resume.data_birth)}}
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="box-element-vacancy">
                                                                    ...
                                                                    <div :class="`value-element value-element_${key}`" class=" important"
                                                                         v-html="resume.text_experience"
                                                                    ></div>
                                                                </div>

                                                                <!-- Ожидания от должности -->
                                                                <div class="box-element-vacancy">
                                                                    <div class="title-element-vacancy">
                                                                        Ожидания от должности
                                                                    </div>
                                                                    <div :class="`value-element value-element_${key}`" class=" important"
                                                                         v-html="resume.text_wait"
                                                                    ></div>
                                                                </div>
                                                                ...
                                                                <div class="box-element-vacancy">
                                                                    ...
                                                                    <div :class="`value-element value-element_${key}`" class=" important"
                                                                         v-html="resume.text_achievements"
                                                                    ></div>
                                                                </div>
                                                                ...
                                                                <div class="but-box">
                                                                    ...
                                                                    <button type="submit" class="btn btn-block btn-danger"
                                                                            @click="verifiedByAdmin(0, resume.id, `dataDocument_${key}`)"
                                                                    >
                                                                        Заблокировать
                                                                    </button>
                                                                    <button type="submit" class="btn btn-block btn-primary"
                                                                            @click="verifiedByAdmin(1, resume.id, `dataDocument_${key}`)"
                                                                        >
                                                                        Допустить
                                                                    </button>
                                                                </div>
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <table class="table-statistic" :id="`table-statistic_${key}`">
                                                                    ...
                                                                    <tbody>
                                                                        <tr class="row">
                                                                            <td class="col-sm-1">
                                                                                <a :href="`/admin-panel/users?user_id=${resume.user_id}`"
                                                                                   class="link-a" target="_blank"
                                                                                >
                                                                                    {{resume.user_id}}
                                                                                </a>
                                                                            </td>
                                                                            <td class="col-sm-1">{{resume.statistic.show}}</td>
                                                                            <td class="col-sm-1">{{resume.statistic.view}}</td>
                                                                            <td class="col-sm-1">{{resume.statistic.respond}}</td>
                                                                            <td class="col-sm-8">{{resume.statistic.update}}</td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                ...
                                <div v-if="!resumes.length" class="image-not-found"></div>
                            </div>
                        </div>
                    </div>
        ...
        <pagination
            v-if="response.resumes.last_page > 1"
            :pagination="response.resumes"
            @paginate="urlReload"
            :offset="1"
        >
        </pagination>
...
<script>
    ...
    export default {
        ...
        methods: {
            async verifiedByAdmin(bool, resume_id, id_collapse){
                let data = {
                    id: resume_id,
                    verified: bool,
                };
                const response = await this.$http.post(`/admin-panel/resumes/verified-by-admin`, data)
                    .then(res => {
                        if(this.checkSuccess(res)){
                            this.changeObj(resume_id, bool)
            ...
            // после проверки
            changeObj(resume_id, verified){
                for(let i = 0; i < this.resumes.length; i++){
                    if(this.resumes[i].id === resume_id){
                        this.resumes[i].check_admin = 1
                        this.resumes[i].published = verified
                        this.resumes[i].job_posting.status_name = !verified ? "hidden" : 'standard'
                        break
                    }
                }
            },
        ...
        mounted() {
            this.resumes = this.response.resumes.data
