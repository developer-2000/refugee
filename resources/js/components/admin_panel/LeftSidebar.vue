                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="/admin-panel/translate-regions?language=en" class="nav-link">
                                        <svg class="small-dot" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path d="M320 256c0 88.37-71.63 160-160 160S0 344.37 0 256 71.63 96 160 96s160 71.6 160 160z"/></svg>
                                        <p class="nav-tab">
                                            Регионы
                                        </p>
        ...
        methods: {
            ...
            openNavBar(){
                ...
                arrElements.forEach(parent => {
                    ...
                    aTags.forEach(a => {
                        // последний prefix link - /admin-panel/translate-countries?language=en
                        let str = $(a).attr("href")
                        str = str.split('?')
                        str = str[0].split('/')
                        let last_prefix = str[str.length-1]

                        if(url.href.indexOf(last_prefix) !== -1){
