<template>
    <div class="forms">
        <h1 class="title_page card-body">Мои вакансии</h1>
        ...
        <div class="box-vacancy">
            ...
            <div class="left-site">
                ...
                <div class="address-vacancy">
                    Одесса, ищем в Киеве, вулиця Дерибасівська, 3
                </div>
            ...
            <div class="right-site">
                ...
                <div class="button-vacancy">
                    <button type="button" class="btn btn-block btn-outline-primary">Разместить</button>
