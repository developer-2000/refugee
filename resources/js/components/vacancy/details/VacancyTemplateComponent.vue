    ...
    <div class="view-page">
        ...
        <div class="box-title">
            ...
            <h2 v-if="page !== 'show'" class="title-vacancy">
                ...
                <svg v-if="ids_respond !== undefined && ids_respond.indexOf(vacancy.id) !== -1"
            ...
            <template v-if="page === 'show'">
                ...
                >
                    <div class="company-vacancy">
                        ...
                        <img class="img-logo"
                             ...
                             :alt="`${trans('vacancies','company_logo')} ${vacancy.company.title}`"
                        >
                    </div>
                </a>
                ...
                <div v-else class="default-company">
                    ...
                    <img class="img-logo"
                         :src="`/${vacancy.company.image.url}`"
                         :alt="`${trans('vacancies','default_company_logo')} ${vacancy.company.title}`"
                    >
                </div>
            </template>
            ...
            <!-- проверка контента вакансии -->
            <template v-else-if="page === 'my_vacancies'">
                <!-- на проверке -->
                <div v-if="checkAccess(vacancy)" class="no-verified" >
...
<!--                </a>-->
        ...
        <div class="line-div box-salary">
            <div class="font-weight-bold salary-vacancy">
                <div data-toggle="tooltip" data-trigger="manual"
                     :title="trans('vacancies','salary2')"
                >
                    <span class="box-svg">
        ...
        <!-- languages -->
        <div v-if="lang.lang !== undefined" class="line-div">
            <div class="font-weight-bold languages-vacancy">
                <div data-toggle="tooltip" data-trigger="manual"
                     :title="trans('vacancies','languages')"
                >
                    <span class="box-svg">
        ...
        <div class="line-div box-address">
            <div class="font-weight-bold address-vacancy">
                <div data-toggle="tooltip" data-trigger="manual"
                     :title="trans('vacancies','work_localization')"
                >
                    <span class="box-svg">
        ...
        <template v-if="page !== 'my_vacancies'">
            ...
            <div class="line-div experience">
                <div data-toggle="tooltip" data-trigger="manual"
                     :title="trans('vacancies','work_experience2')"
                >
                    <span class="box-svg">
            ...
            <div class="line-div age-vacancy">
                <div data-toggle="tooltip" data-trigger="manual"
                     :title="trans('vacancies','age_requirement')"
                >
                    <span class="box-svg">
