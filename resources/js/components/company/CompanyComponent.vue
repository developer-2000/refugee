<template>
    <div class="box-page">
        ...
        <div class="left-site">
            <!-- company logo -->
            <div class="box-title">
                <img src="/img/company/company-default.jpg" alt="Test image">
        ...
        <div class="right-site">
            ...
            <div class="box-about-company">
                <h3 class="font-weight-bold">О компании</h3>
            ...
            <div class="box-media-files">
                <h3 class="font-weight-bold">Медиафайлы</h3>
                <div class="container-fluid block-media-files ">
                    <div class="row">
                        <img class="col-sm-4" src="/img/company/media_file.png" alt="Test image">
                        <img class="col-sm-4" src="/img/company/media_file.png" alt="Test image">
                        <img class="col-sm-4" src="/img/company/media_file.png" alt="Test image">
                    </div>
                </div>
            ...
            <div class="box-company-vacancies">
                <h3 class="font-weight-bold">Вакансии компании</h3>
                <div class="container-fluid block-company-vacancies">
                    <div class="row">
                        <img class="col-sm-12" src="/img/company/vacancy.png" alt="Test image">
                        <img class="col-sm-12" src="/img/company/vacancy.png" alt="Test image">
                        <img class="col-sm-12" src="/img/company/vacancy.png" alt="Test image">
                    </div>
                </div>
