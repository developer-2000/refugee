    ...
    <div class="view-page">
        ...
        <div class="box-title">
            ...
            <template v-else-if="page === 'my_resumes'">
                <!-- на проверке - не опубликован и -->
                <div v-if="checkAccess(resume)" class="no-verified" >
        ...
        <template v-if="page !== 'my_resumes'">
            ...
            <div class="box-textarea">
                ...
                <!-- указатель большего контента на странице поска -->
        ...
        <div v-if="page === 'my_resumes'" class="footer-vacancy">
            ...
            <div class="date-document">
                ...
                <!-- резюме закрыта -->
                <div class="close-document-fon"
                     v-if="getStatusInDay(resume.job_posting) <= 0"
                >
                    {{trans('vacancies','resume_hidden')}}
                </div>
