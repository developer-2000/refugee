    ...
    <div>
        ...
        <div class="box-title">
            ...
            <a class="link-a" target="_blank"
               :href="`${lang.prefix_lang}company/${resume.company.alias}`"
            >
                <div class="company-vacancy">
                        <div class="font-weight-bold title-company"> {{resume.company.title}} </div>
                        <img class="img-logo"
                             :src="`/${resume.company.image.url}`"
                             :alt="resume.company.image.title"
                        >
                </div>
            </a>
<!--            &lt;!&ndash; на странице search vacancies &ndash;&gt;-->
<!--            <div class="company-vacancy" >-->
<!--                <div class="font-weight-bold title-company"> {{resume.company.title}} </div>-->
<!--                <img class="img-logo"-->
<!--                     :src="`/${resume.company.image.url}`"-->
...
<!--            </span>-->
<!--                &lt;!&ndash; указан &ndash;&gt;-->
<!--                <div v-if="resume.resume_suitable.radio_name == 'set_age'"-->
<!--                     class="font-weight-bold first_half"-->
<!--                >-->
<!--                    {{resume.resume_suitable.inputs.from}} - {{resume.resume_suitable.inputs.to}} {{trans('vacancies','years')}}-->
<!--                </div>-->
<!--                &lt;!&ndash; не имеет значения &ndash;&gt;-->
<!--                <div v-else-if="resume.resume_suitable.radio_name == 'it_not_matter'"-->
<!--                     class="font-weight-bold first_half"-->
<!--                >-->
<!--                    {{UpperCaseFirstCharacter( trans('vacancies',resume.resume_suitable.radio_name) )}}-->
<!--                </div>-->
<!--                &lt;!&ndash; comment &ndash;&gt;-->
<!--                <div class="comment-vacancy"-->
<!--                     v-if="resume.resume_suitable.comment !== null"-->
<!--                >-->
<!--                    <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">-->
<!--                        <path-->
<!--                            d="M489.1 363.3l-24.03 41.59c-6.635 11.48-21.33 15.41-32.82 8.78l-129.1-74.56V488c0 13.25-10.75 24-24.02 24H231.1c-13.27 0-24.02-10.75-24.02-24v-148.9L78.87 413.7c-11.49 6.629-26.19 2.698-32.82-8.78l-24.03-41.59c-6.635-11.48-2.718-26.14 8.774-32.77L159.9 256L30.8 181.5C19.3 174.8 15.39 160.2 22.02 148.7l24.03-41.59c6.635-11.48 21.33-15.41 32.82-8.781l129.1 74.56L207.1 24c0-13.25 10.75-24 24.02-24h48.04c13.27 0 24.02 10.75 24.02 24l.0005 148.9l129.1-74.56c11.49-6.629 26.19-2.698 32.82 8.78l24.02 41.59c6.637 11.48 2.718 26.14-8.774 32.77L352.1 256l129.1 74.53C492.7 337.2 496.6 351.8 489.1 363.3z"/>-->
<!--                    </svg>-->
<!--                    {{resume.resume_suitable.comment}}-->
<!--                </div>-->
<!--            </div>-->
...
<!--                </div>-->
<!--            </div>-->
<!--            &lt;!&ndash; Описание вакансии &ndash;&gt;-->
<!--            <div v-if="page == 'show'"-->
<!--                 class="textarea-vacancy"-->
<!--            >-->
<!--                <b>{{trans('vacancies','job_description')}}</b>-->
<!--                <div v-html="resume.text_description"></div>-->
<!--            </div>-->
<!--            <div v-else-if="page == 'search' && resume.text_description"-->
<!--                 class="textarea-vacancy"-->
<!--            >-->
<!--                <b>{{trans('vacancies','job_description')}}</b><br>-->
<!--                {{ cutTags(resume.text_description).slice(0, 150) }}-->
...
<!--                </div>-->
<!--            </div>-->
<!--            &lt;!&ndash; next description &ndash;&gt;-->
<!--            <template v-if="page == 'show'">-->
<!--                &lt;!&ndash; Условия работы &ndash;&gt;-->
<!--                <div class="textarea-vacancy">-->
<!--                    <b>{{trans('vacancies','working_conditions')}}</b>-->
<!--                    <div v-html="resume.text_working"></div>-->
<!--                </div>-->
<!--                &lt;!&ndash; Обязанности кандидата &ndash;&gt;-->
<!--                <div class="textarea-vacancy">-->
<!--                    <b>{{trans('vacancies','candidate_responsibilities')}}</b>-->
<!--                    <div v-html="resume.text_responsibilities"></div>-->
<!--                </div>-->
<!--            </template>-->
<!--        </template>-->
