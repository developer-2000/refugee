        ...
        <div class="bottom-search">
            ...
            <div class="box-show">
                ...
                <div class="right-site">
                    ...
                    <!-- ckeditor -->
                    <div id="box-ckeditor">
                        <label v-if="!objUpdate.bool_update">
                            Написать сообщение
                        </label>
                        <label v-else>
                            Обновить сообщение
                        ...
                        <div v-if="objUpdate.bool_update" class="button-update">
    ...
    export default {
        ...
        methods: {
            ...
            selectTextForUpdate(index) {
                ...
                this.objUpdate.bool_update = true
                this.objUpdate.index = index
            ...
            cancelUpdate() {
                this.objTextarea.textarea_letter = ''
                this.objUpdate.bool_update = false
                this.objUpdate.index = null
            },
        },
        props: [
            'user',
