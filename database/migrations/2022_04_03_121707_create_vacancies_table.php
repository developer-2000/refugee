...
class CreateVacanciesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('vacancies', function (Blueprint $table) {
            ...
            $table->string('salary')->index()->nullable()->default(null)->comment('зарплата - одно значение, диапазон, не указано, коментарий');
            ...
            $table->string('contacts')->index()->nullable()->default(null)->comment('какие контакты связи показать соискателю');
